...
|
*/
Route::get('proker', [App\Http\Controllers\ProkerController::class, 'datapro']);
Route::get('proker/create', [App\Http\Controllers\ProkerController::class, 'create']);
Route::post('proker/create', [App\Http\Controllers\ProkerController::class, 'store']);
...
Route::get('/datapeng', function () {
    return view('pengurus.datapeng', [
        "title" => "datapeng"
    ]);
});
...
Route::get('/datapro', function () {
    return view('proker.datapro', [
        "title" => "datapro"
    ]);
});

Route::get('/inventaris', function () {
    return view('int.inventaris', [
        "title" => "inventaris"
    ]);
});
